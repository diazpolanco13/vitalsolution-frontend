        ...
        <tr className="table-fixed">
          ...
          <td className="text-sm font-medium text-center text-gray-900 whitespace-pre-wrap border-r border-gray-200">
            <button
              ...
              className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-800 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 uppercase"
            >
              Modificar
            </button>
          </td>
          <td className="text-sm font-medium text-center text-gray-900 whitespace-pre-wrap border-r border-gray-200">
            <button
              ...
              className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-red-800 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 uppercase"
            >
