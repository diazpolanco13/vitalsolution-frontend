...
const Login = () => {
  return (
    <>
      <div className="">
        <div class="bg-gradient-to-r from-teal-400 to-blue-500 min-h-screen bg-gray-50 flex flex-col shadow-2xl justify-center py-12 sm:px-6 lg:px-8">
          <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <img
              ...
              alt="Workflow"
            />
              <h2 class="mt-6 text-center text-3xl font-extrabold text-blue-800 font-sans ">
              BIENVENIDO 
            </h2>
          </div>
                ...
                <div class="mt-6 grid grid-cols-3 gap-3">
                  ...
                  <div>
                    <a
                      ...
                      class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
                    >
                      <span class="sr-only">Inicio de sesión con Twitter</span>
                      <svg
                        class="w-5 h-5"
                        fill="currentColor"
                        viewBox="0 0 20 20"
