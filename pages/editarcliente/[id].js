...
const EditarCliente = () => {
  ...
  return (
    <div>
      <Dashboard>
        <h1 className="text-lg">Desde Editar {id}</h1>
{/*    
       <main
                  ...
                  <div className="pt-8">
                    ...
                    <div className="grid grid-cols-1 mt-6 gap-y-6 gap-x-4 sm:grid-cols-6">
                      ...
                      <div className="sm:col-span-3">
                        ...
                        {formik.touched.documentoIndentidad &&
                        formik.errors.documentoIndentidad ? (
                          <span className="inline-flex items-center justify-self-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-red-500 text-white">
                            {formik.errors.documentoIndentidad}
                          </span>
                      ...
                      <div className="col-start-1 sm:col-span-4">
                        ...
                        <div className="mt-1">
                          <select
                            ...
                            placeholder={`${
                              formik.errors.estado && formik.errors.estado
                            }`}
                          ...
                          <div className="relative flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                              ...
                              <p className="text-gray-500">
                                Recibe una notificación cuando existan ofertas
                          ...
                          <div className="relative flex items-start">
                            <div className="flex items-center h-5">
                              <input
                                ...
                                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                value={
                                  formik.values.planAfiliacion.recordatorio
                                }
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                              />
                            ...
                            <div className="ml-3 text-sm">
                              ...
                              <p className="text-gray-500">
                                Recibe un recordatorio para adquirir nuestros
                                productos 30 dias despues de tu ultima compra.
                              </p>
                            </div>
                          </div>
